...
@Component({
  ...
  imports: [TrackList, TranslateModule, EntityHeaderComponentComponent],
...
export class CollectionPage {
  ...
  headerDiscriptionData = { username: this.authService.user()?.displayName} as HeaderDescriptionData
